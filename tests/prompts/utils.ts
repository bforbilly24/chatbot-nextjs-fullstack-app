...
`),
  ...
  } else if (compareMessages(recentMessage, TEST_PROMPTS.GET_LOCATION_INFO)) {
    return [
      ...textToDeltas('San Francisco is a vibrant city in California known for its Golden Gate Bridge, tech industry, and diverse culture.'),
      {
        type: 'finish',
        finishReason: 'stop',

...
const CodeBlock = ({
    ...
    const preClass = cn(
        "overflow-x-auto rounded-md border bg-background/50 p-4 font-mono text-sm [scrollbar-width:none] whitespace-pre-wrap break-words max-w-full",
        className
    )
...
const COMPONENTS = {
    ...
    p: withClass("p", "whitespace-pre-wrap break-words max-w-full"),
